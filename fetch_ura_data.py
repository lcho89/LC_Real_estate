...
def main():
    parser = argparse.ArgumentParser(
        description="Fetch URA residential transaction data for sg-condo-dashboard.html"
    )
    ...
    print()
    print("=" * 60)
    print("  URA Transaction Data Fetcher - sg-condo-dashboard.html")
    print("=" * 60)
    print()
    ...
    print()
    print("  Next step:")
    print(f"   Place '{output_path}' in the same folder as sg-condo-dashboard.html")
    print("   Then open (or refresh) sg-condo-dashboard.html — it will load automatically.")
    print()
